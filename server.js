...
app.post("/addModule", (req, res) => {
  var array = [req.body.title,req.body.videoUrl,req.body.coursId];
  db.addModule(array, (err, data) => {
    err ? console.log(err) : res.send(data);
  });
});
app.post("/modules", (req, res) => {
  var array = [req.body.coursId];
  db.getModules(array, (err, data) => {
    err ? console.log(err) : res.send(data);
  });
});
app.post("/paragraphs", (req, res) => {
  var array = [req.body.ModuleId];
  db.getPragraphs(array, (err, data) => {
    err ? console.log(err) : res.send(data);
  });
});
app.post("/addParagraph", (req, res) => {
  var array = [req.body.title,req.body.imageUrl,req.body.content,req.body.ModuleId];
  db.addParagraphs(array, (err, data) => {
    err ? console.log(err) : res.send(data);
  });
});
